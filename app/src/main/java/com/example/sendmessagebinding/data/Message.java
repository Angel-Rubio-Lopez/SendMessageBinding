...
public class Message implements Serializable, Parcelable {
    ...
    /*Por defecto si no se declara un constructor, Java implementa un constructor vacio
    ...
    @NonNull
    @Override
    public  String toString() { return getUser() + "-> " + getContent(); }

    //region MÉTODOS CREADOS DE LA INTERFAZ SERIALIZABLE
